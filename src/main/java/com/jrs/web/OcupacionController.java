...
import com.jrs.services.OcupacionSerive;
...
public class OcupacionController {
    ...
    @Autowired
    private OcupacionSerive ocupacionSerive;
    ...
    public List<OcupacionResponse> getAllOcupaciones( ) {
        return ocupacionSerive.getAll( );
    }
     ...
     */
    @Operation(description = "Obtener ocupaciones por tipo",
            summary = "Obtener todas las ocupaciones de un tipo", responses = {
            @ApiResponse(description = "Todo ok", responseCode = "200")
    })
    @GetMapping("getOcupacionPorTipo")
    public List<OcupacionCompletoDTO> getOcupacionPorTipo(
            ...
            String tipo ) {
        return this.ocupacionSerive.getOcupacionPorTipo( tipo );
    }
